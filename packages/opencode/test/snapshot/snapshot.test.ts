...
test.skip("symlink handling", async () => {
  await using tmp = await bootstrap()
  await Instance.provide({
    directory: tmp.path,
    fn: async () => {
...
test.skip("very long filenames", async () => {
  await using tmp = await bootstrap()
  await Instance.provide({
    directory: tmp.path,
    fn: async () => {
...
test.skip("nested symlinks", async () => {
  await using tmp = await bootstrap()
  await Instance.provide({
    directory: tmp.path,
    fn: async () => {
...
test.skip("file permissions and ownership changes", async () => {
  await using tmp = await bootstrap()
  await Instance.provide({
    directory: tmp.path,
    fn: async () => {
...
test("snapshot state isolation between projects", async () => {
  ...
  await Instance.provide({
    ...
    fn: async () => {
      ...
      await Bun.write(path.join(tmp1.path, "project1.txt"), "project1 content")
  ...
  await Instance.provide({
    ...
    fn: async () => {
      ...
      await Bun.write(path.join(tmp2.path, "project2.txt"), "project2 content")
